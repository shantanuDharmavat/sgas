...
/**
 * Created by Abhijit on 22-12-2016.
 */

public class DirectionMap extends ActualMapActivity implements OnMapReadyCallback,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LatLng latLng = new LatLng(globalVariable.getmGlobalCurrentLocation().getLatitude(), globalVariable.getmGlobalCurrentLocation().getLongitude());
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                if (MarkerPoints.size() == 0)
                    MarkerPoints.add(new Utilities().getLatLng(mCurrentLocation));
...
//                    mMap.moveCamera(CameraUpdateFactory.newLatLngBounds(builder.build(),100));
    ...
    private Location getLastKnownLocation() {
        ...
        Log.e("best location", "value = " + bestLocation);
        return bestLocation;
    }
